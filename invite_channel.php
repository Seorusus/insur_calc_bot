...
/** -------------------------------------------------- */
//$channel_id = '-1001824390876';
//$textMessage = 'Скористайтеся Страховим калькулятором:
//
//✅ щоб розрахувати вартість  річних премій та виплат.
//✅ ознайомитись з різними видами накопичувальних програм з медичним захистом.
//
//⬇️⬇️⬇️ отримати консультацію експерта ⬇️⬇️⬇️';
//// Check if the message text is NOT the text we send
