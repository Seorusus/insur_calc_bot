...
⬇️⬇️⬇️ Виберайте з чого почнемо ⬇️⬇️⬇️",
        ...
        if (($text === '⬆️⬆️⬆️ Повернутись до вибору групи програм') && (!$telegram->messageFromGroup())) {
                $reply = "<b>Дивiться.</b>\nЦе програми які доступні українцям та діють по всьому світу.\n\nВибирайте групу програм\n⬇️⬇️⬇️";
            // Create option for the custom keyboard. Array of array string
            $option = [
                [
...
⬇️⬇️⬇️";
            ...
            $option = [
                ...
                ['💬 Отримати консультацiю експерта'],
            ];
            // Get the keyboard
            $keyb = $telegram->buildKeyBoard($option, true, true, false);
        ...
        if (($text === '👨‍👨‍👦‍👦 Страхування групи осіб') && (!$telegram->messageFromGroup())) {
...
Наші програми дуже гнучкі, і ми можемо комбінувати страховий захист залежно від Ваших побажань та особливостей роботи підприємства. Будь ласка, не соромтесь звертатися до наших спеціалістів, вони допоможуть обрати найбільш вигідну пропозицію для страхування Ваших працівників.";
            // Create option for the custom keyboard. Array of array string
            $option = [
                ['⬆️⬆️⬆️ Повернутись до вибору групи програм'],
                ['💬 Отримати консультацiю експерта'],
            ];
            // Get the keyboard
            $keyb = $telegram->buildKeyBoard($option, true, true, false);
        ...
        if (($text === '👨‍🦳 Пенсійний опціон') && (!$telegram->messageFromGroup())) {
...
";
        ...
        if (($text === '🪴 Захист здоров’я') && (!$telegram->messageFromGroup())) {
...
Програми СЕП  ⬇️⬇️⬇️";
        ...
        if (($text === '🏛  Граве Класік - зважена інвестиція коштів') && (!$telegram->messageFromGroup())) {
...
Програми ГРАВЕ КЛАСИК   ⬇️⬇️⬇️";
        ...
        if (($text === '🥇  Граве Голд - накопичення вагомого капіталу') && (!$telegram->messageFromGroup())) {
...
Програми ГРАВЕ Голд   ⬇️⬇️⬇️";
        ...
        if (($text === '🗓  ІНВЕСТ План - для майбутніх значних витрат або додаткової пенсії') && (!$telegram->messageFromGroup())) {
...
Програми ІНВЕСТ План   ⬇️⬇️⬇️";
        ...
        if (($text === '🤱  ЮНІОР Екстра - Захист годувальника та дитини') && (!$telegram->messageFromGroup())) {
...
Програми ЮНІОР ЕКСТРА  ⬇️⬇️⬇️";
        ...
        if (($text === '👨🏻‍🎓  Граве Магістр - накопичення коштів для навчання') && (!$telegram->messageFromGroup())) {
...
Програми ГРАВЕ Магістр  ⬇️⬇️⬇️";
        ...
        if (($text === '🌐  ГРАВЕ Універсал - Можливість вибору ступеня захисту') && (!$telegram->messageFromGroup())) {
...
Програми ГРАВЕ Універсал  ⬇️⬇️⬇️";
        ...
        if (($text === '⬇️⬇️⬇️ Iншi програми Особистого страхування життя') && (!$telegram->messageFromGroup())) {
        ...
        if (($text === '⬇️⬇️⬇️ Повернутись до списку програм Захисту здоров’я') && (!$telegram->messageFromGroup())) {
            $reply = "Програми <b>Особистого страхування життя</b>";
            // Create option for the custom keyboard. Array of array string
            $option = [
                ['🌱  Програма СЕП - широкий страховий захист'],
        ...
        if (($text === '❤️‍🔥  ГРАВЕ Медик - Захист за двома програмами страхування') && (!$telegram->messageFromGroup())) {
...
";
            // Create option for the custom keyboard. Array of array string
            $option = [
                ['❤️‍🔥  ГРАВЕ Медик - Накопичувальна програма'],
                ['❤️‍🔥  ГРАВЕ Медик - Страхування настання ризиків'],
            ];
            // Get the keyboard
            $keyb = $telegram->buildKeyBoard($option, true, true, false);
            $content = ['chat_id' => $chat_id, 'reply_markup' => $keyb, 'text' => $reply, 'parse_mode' => "html",];
        ...
        if (($text === '❤️‍🔥  ГРАВЕ Медик - Накопичувальна програма') && (!$telegram->messageFromGroup())) {
...
ГРАВЕ Медик - Накопичувальна програма  ⬇️⬇️⬇️";
            ...
            $option = [
                ...
                ['⬇️⬇️⬇️ Повернутись до списку програм Захисту здоров’я'],
                ['💬 Отримати консультацiю експерта'],
            ];
            // Get the keyboard
            $keyb = $telegram->buildKeyBoard($option, true, true, false);
        ...
        if (($text === '❤️‍🔥  ГРАВЕ Медик - Страхування настання ризиків') && (!$telegram->messageFromGroup())) {
...
ГРАВЕ Медик - Страхування настання ризиків  ⬇️⬇️⬇️";
        ...
        if (($text === '💬 Отримати консультацiю експерта') && (!$telegram->messageFromGroup())) {
            $content = [
            'chat_id' => $chatId,
            'text' => "Ви можете безпосередньо поставити запитання щодо страхових програм та отримати безкоштовну консультацію <b>експерта</b>.",
            'parse_mode' => "html",
