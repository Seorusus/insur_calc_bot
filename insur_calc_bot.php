...
define("CONSULTATION", "💬 Отримати консультацiю експертки", true);
...
define("SEP", "🌱  Програма СЕП - широкий страховий захист", true);
...
define("SUPPORT_HEALTH_3", "Граве Підтримка 3 - Захист на випадок діагностування важких хвороб", true);
...
if ($arrDataAnswer['message']) {
    if ($arrDataAnswer['message']['text'] === INS_CALCULATOR) {
        $content = [
            'chat_id' => CHAT_ID,
            'text' =>
...
<b><i>розрахунок страховки.</i></b>",
        ...
        $telegram->sendMessage($content);
    } elseif ($arrDataAnswer['message']['text'] === CONSULTATION) {
        $content = [
            'chat_id' => $chatId,
...
Програми " . GRAVE_MEDIC_ACCUMULATION . "⬇️⬇️⬇️";
                    ...
                    // Create option for the custom keyboard. Array of array string
                    $option = [
                        ["🧮 Розрахунок " . GRAVE_MEDIC_ACCUMULATION],
                        [RETURN_LIST_HELTH_PROT],
                        [CONSULTATION],
                    ];
                    // Get the keyboard
...
Програми " . GRAVE_MEDIC_RISK_INS ."⬇️⬇️⬇️";
                    ...
                    // Create option for the custom keyboard. Array of array string
                    $option = [
                        ["🧮 Розрахунок" . GRAVE_MEDIC_RISK_INS],
                        [RETURN_LIST_HELTH_PROT],
                        [CONSULTATION],
                    ];
                    // Get the keyboard
